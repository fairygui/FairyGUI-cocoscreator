...
namespace fgui {
    ...
    export class GList extends GComponent {
        ...
        public get virtualItemSize(): cc.Size {
            return this._itemSize;
        }

        public set virtualItemSize(value: cc.Size) {
            if (this._virtual) {
        ...
        public scrollToView(index: number, ani?: boolean, setFirst?: boolean): void {
            if (this._virtual) {
                ...
                if (this._layout == ListLayoutType.SingleColumn || this._layout == ListLayoutType.FlowHorizontal) {
                    ...
                    rect = new cc.Rect(page * this.viewWidth + (index % this._curLineItemCount) * (ii.width + this._columnGap),
            ...
            if (this._virtual) {
                ...
                if (this.itemRenderer != null) {
                    for (i = 0; i < value; i++){
						...
						if (item && (<GComponent>item).ensureBoundsCorrect) {(<GComponent>item).ensureBoundsCorrect();}
                    }
                }
            }
        }
